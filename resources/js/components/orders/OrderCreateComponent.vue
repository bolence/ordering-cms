      ...
      >
        <div class="card-body p-4">
          ...
          >
            ...
            <div class="col-mx-auto float-end">
              <div class="form-check form-check-inline pl-2">
                ...
                />
                <label class="form-check-label fw-bold" for="tshirt"
                  >Majice</label
                >
              </div>
              ...
              <div class="form-check form-check-inline">
                <input
                  ...
                  v-model="data.order_type"
                />
                <label class="form-check-label fw-bold" for="badges"
                  >Bedževi</label
                >
              </div>
            </div>
          ...
          <form class="row g-3 pb-3">
            ...
            <div class="col-md-3">
              <label for="from" class="form-label fw-bold">Poručeno sa:</label>
              <div class="input-group">
                <span class="input-group-text bg-transparent"
                ...
                >
                  <option value="null">Izaberi odakle je poručeno</option>
            ...
            <div class="col-auto">
              <label for="payment" class="form-label fw-bold">Plaćanje:</label>
              <div class="form-check px-1">
                ...
                <div class="form-check form-check-inline mt-2">
                  ...
                  />
                  <label class="form-check-label" for="virman">Virman</label>
                </div>
              </div>
              <div
            ...
            <div class="col-auto">
              <label for="payment" class="form-label fw-bold">Dostava:</label>
              <div class="form-check px-1">
                <div class="form-check form-check-inline mt-2">
                  <input
                    class="form-check-input"
                  ...
                  />
                  <label class="form-check-label" for="lično">Lično</label>
                </div>
                ...
                <div class="form-check form-check-inline mt-2">
                  ...
                  />
                  <label class="form-check-label" for="dostava">Dostava</label>
                </div>
              </div>
              <div
            ...
            <div class="col-12">
              <label for="inputChoosePassword" class="form-label fw-bold"
                >Napomena</label
              >
              <div>
                <textarea
            ...
            <div class="row pt-3" v-if="data.delivery_type == 'dostava'">
              <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 text-uppercase pb-3">Podaci za dostavu</h5>
                <span class="float-end">
                  <div class="form-check form-check-inline mt-2">
                    <input
                      ...
                      @change="setSamePhone()"
                      v-model="data.customer.customer_details"
                    />
                    <label class="form-check-label" for="customer_details"
              ...
              <div class="col-md-3">
                <label for="name" class="form-label">Ime/Firma</label>
                <input
                  class="form-control"
                  id="delivery_name"
                  name="delivery_name"
              ...
              <div class="col-md-3">
                <label for="street" class="form-label">Grad</label>
                <input
                  class="form-control"
                  id="city"
                  name="city"
              ...
              <div class="col-md-3">
                <label for="phone2" class="form-label">Telefon</label>
                <input
                  class="form-control"
                  id="phone2"
                  name="phone2"
            ...
            >
              <div class="col-md-3">
                ...
                />
                <div v-if="errors.price" class="invalid-feedback error-message">
                  {{ errors.price[0] }}
                </div>
              </div>
              <div class="col-md-6">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-bordered mb-0">
              ...
              <tbody>
                <tr v-for="(item, index) in newOrder.tshirt" :key="index">
                  <td>
                    {{ item.tshirt_color }}
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="d-flex order-actions">
                      <a
                        href=""
                        class="ms-3"
                        @click.prevent="removeTshirt(index)"
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-bordered mb-0">
              ...
              <tbody>
                <tr v-for="(item, index) in newOrder.badges" :key="index">
                  <td>
                    {{ item.badge_size }}
                  </td>
